package com.sts.admin.constants;
...
public class AppConstants {
    ...
    public static final String PLAN_STATUS_SAVE_FAIL="planStatusSaveFail";

    public static final String PLAN_SAVE_ERR="planSaveErr";
